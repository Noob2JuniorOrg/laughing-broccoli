...
const Header = () => {
  return (
    <div className="relative pt-[2.667em] px-[1.6em] pb-0 xl:p-0 h-[43.333rem] bg-[url('./pages/loopstudios/images/mobile/image-hero.jpg')] xl:bg-[url('./pages/loopstudios/images/desktop/image-hero.jpg')] bg-no-repeat bg-cover bg-black/40">
      ...
      <div className="flex justify-between relative xl:px-[165px] xl:pt-[64px]">
        ...
        <nav className="hidden font-loopstudios text-white xl:flex justify-between xl:min-w-[380px] ">
      ...
      <div className="relative xl:w-[40.625rem] xl:h-[17.375rem] border-white border-2 p-[2.5rem] mt-[163px] xl:mt-[123px] xl:ml-[165px]">
