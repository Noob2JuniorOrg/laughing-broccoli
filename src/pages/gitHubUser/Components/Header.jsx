    ...
    <div className="header-main-style">
      ...
      >
        ...
        <div className="group text-gray-500">
          <svg
            className="dark:hidden fill-current group-hover:fill-black transition-colors"
            width="20"
            height="20"
      ...
      >
        ...
        <div className="group text-white hidden dark:inline-block">
          <svg
            className="fill-current group-hover:fill-[#90A4D4] transition-colors w-[20px] h-[20px]"
            xmlns="http://www.w3.org/2000/svg"
          >
            <g>
